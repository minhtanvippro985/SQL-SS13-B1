...
BEGIN 
	IF OLD.appointment_date < NOW() THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'KHONG THE DAT TRONG QUA KHU';
    
	END IF;	
END //

DELIMITER ;
-- do ta đang so thời gian cũ với thời điểm hiện tại nên nó trong trạng thới lúc nào cũng đúng 
-- vì thế sẽ đổi lại thành 
...
BEGIN 
	...
	END IF;	
END //
-- vì thế so thời gian mới với thời gian cũ sẽ hiệu quả hơn 
DELIMITER ;


SELECT * FROM Appointments;
UPDATE Appointments 
SET appointment_date = '2024-06-10 08:30:00'
